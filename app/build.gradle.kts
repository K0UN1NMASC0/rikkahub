...
plugins {
    ...
    // alias(libs.plugins.google.services)      // Tulpa: 不需要原作者的Firebase
    // alias(libs.plugins.firebase.crashlytics)  // Tulpa: 同上
...
dependencies {
    ...
    // Firebase (Tulpa: disabled - 不需要原作者的crash收集)
